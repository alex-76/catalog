...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="header-h3"><span class="glyphicon glyphicon-globe"></span> Регіони</div>
            <?php echo MenuWidget::widget(); ?>
            <div class="header-h3"><span class="glyphicon glyphicon-list-alt"></span> Останні новини</div>
